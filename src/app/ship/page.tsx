      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-2 bg-[#B88E2F] text-white rounded-md hover:bg-green-600 disabled:bg-gray-400"
          >
        ...
        {rateId && (
          <div className="mt-8">
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-2 bg-[#B88E2F] text-white rounded-md hover:bg-blue-600 disabled:bg-gray-400"
            >
        ...
        {trackingObj && (
          <div className="mt-8">
            ...
            <Link href={`/tracking/?labelId=${trackingObj.labelId}`}>
              <button className="px-4 py-2 bg-[#B88E2F] text-white rounded-md hover:bg-blue-600">Track Order</button>
            </Link>
          </div>
        )}
        {errors.length > 0 && (
